...
$i18n = [
    ...
    "api_key_info" => "La clave API se utiliza para acceder a la API de Subsman. No compartas esta clave con nadie.",
    // Settings page
    ...
    "subsman_notification" => "Notificación de Subsman",
    ...
    "ssrf_protection_info" => "Para evitar ataques de falsificación de solicitudes del lado del servidor (SSRF), Subsman bloquea por defecto las notificaciones webhook a direcciones de red privadas o internas.",
