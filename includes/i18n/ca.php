...
$i18n = [
    ...
    "api_key_info" => "La clau API s'utilitza per accedir a l'API de Subsman. No la comparteixis amb ningú.",
    // Settings page
    ...
    "subsman_notification" => "Notificació de Subsman",
    ...
    "ssrf_protection_info" => "Per evitar atacs de Server-Side Request Forgery (SSRF), Subsman bloqueja per defecte les notificacions webhook a adreces de xarxa privades o internes.",
