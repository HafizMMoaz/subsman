...
$i18n = [
    ...
    "api_key" => "API 密钥",
    "regenerate" => "重新生成",
    "api_key_info" => "API 密钥用于与 Subsman API 通信。请勿将此密钥分享给任何人。",
    // 设置页面
    "monthly_budget" => "每月预算",
    ...
    "smtp_info" => "SMTP 密码以明文传输和存储。为安全起见，建议专门为 Subsman 创建一个账户。",
    "telegram" => "Telegram",
    ...
    "test_notification" => "这是一条测试通知。如果您看到此消息，说明 Subsman 通知邮件配置正确。",
    ...
    "ssrf_protection_info" => "为防止服务端请求伪造（SSRF）攻击，Subsman 默认阻止发送到私有或内部网络地址的 webhook 通知。",
