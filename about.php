    ...
    <section class="account-section">
        ...
        <div class="credits-list">
            ...
            <div>
                ...
                <span>
                    GitHub
                    <a href="https://github.com/HafizMMoaz/subsman/issues" target="_blank"
            ...
            <div>
                ...
                <span>
                    https://github.com/HafizMMoaz
                    <a href="https://github.com/HafizMMoaz" target="_blank" title="<?= translate('external_url', $i18n) ?>"
                        rel="noreferrer">
                        <i class="fa-solid fa-arrow-up-right-from-square"></i>
                    </a>
                </span>
            ...
            <div>
                ...
                <span>
                    ...
                    <a href="mailto:hafizmoazkhalid@gmail.com" target="_blank" title="<?= translate('external_url', $i18n) ?>"
                        rel="noreferrer">
                        <i class="fa-solid fa-arrow-up-right-from-square"></i>
                    </a>
                </span>
