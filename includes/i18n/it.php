...
$i18n = [
    ...
    "api_key" => "Chiave API",
    "regenerate" => "Rigenera",
    "api_key_info" => "La chiave API viene utilizzata per accedere ai dati tramite l'API di Subsman. Non condividere la tua chiave API con nessuno.",
    // Settings
    ...
    "subsman_notification" => "Notifica Subsman",
    ...
    "ssrf_protection_info" => "Per prevenire attacchi Server-Side Request Forgery (SSRF), Subsman blocca per impostazione predefinita le notifiche webhook verso indirizzi di rete privati o interni.",
