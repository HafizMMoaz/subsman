...
<head>
  ...
  <title>Subsman - Subscription Tracker</title>
  <meta name="apple-mobile-web-app-title" content="Subsman">
  ...
  <link rel="stylesheet" href="styles/dark-theme.css" id="dark-theme" <?= $theme != "dark" ? "disabled" : "" ?>>
  ...
  <link rel="stylesheet" href="styles/themes/purple.css" id="purple-theme" <?= $colorTheme != "purple" ? "disabled" : "" ?>>
  ...
  <?php
  $hasCustomThemeColors =
    isset($settings['customColors'])
    && (
      (!empty($settings['customColors']['main_color']))
      || (!empty($settings['customColors']['accent_color']))
      || (!empty($settings['customColors']['hover_color']))
    );
...
<body class="<?= $theme ?> <?= $languages[$lang]['dir'] ?> <?= $mobileNavigation ?>">
  <header>
    <div class="contain">
      <div class="logo">
        <a href=".">
          <div class="logo-image" title="Subsman - Subscription Tracker">
