...
if (isset($_FILES['file'])) {
    ...
    if ($fileError === 0) {
        ...
        if (file_exists('../../.tmp/restore/subsman.db')) {
            if (file_exists('../../db/subsman.db')) {
                unlink('../../db/subsman.db');
            }
            rename('../../.tmp/restore/subsman.db', '../../db/subsman.db');
            ...
            die(json_encode([
                "success" => false,
                "message" => "subsman.db does not exist in the backup file"
            ]));
        }
