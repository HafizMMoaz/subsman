...
$i18n = [
    ...
    "subsman_notification" => "Subsman Benachrichtigung",
    ...
    "ssrf_protection_info" => "Um Server-Side Request Forgery (SSRF)-Angriffe zu verhindern, blockiert Subsman standardmäßig Webhook-Benachrichtigungen an private oder interne Netzwerkadressen.",
