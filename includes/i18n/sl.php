...
$i18n = [
    ...
    "subsman_notification" => "Subsmanovo obvestilo",
    ...
    "ssrf_protection_info" => "Za preprečevanje napadov Server-Side Request Forgery (SSRF) Subsman privzeto blokira webhook obvestila na zasebne ali notranje omrežne naslove.",
