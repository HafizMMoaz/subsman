...
$i18n = [
    ...
    "api_key_info" => "API ključ se koristi za pristup Subsman API-ju. Ako mislite da je vaš ključ kompromitovan, možete ga regenerisati.",
    ...
    "subsman_notification" => "Obaveštenje od Subsman-a",
    ...
    "ssrf_protection_info" => "Kako bi se sprečile Server-Side Request Forgery (SSRF) napadi, Subsman podrazumevano blokira webhook obaveštenja ka privatnim ili internim mrežnim adresama.",
