...
$i18n = [
    ...
    "api_key" => "APIキー",
    "regenerate" => "再生成",
    "api_key_info" => "APIキーは、SubsmanのAPIを使用するために必要です。APIキーを再生成すると、以前のキーは無効になります。",
    // Settings page
    "monthly_budget" => "月間予算",
    ...
    "subsman_notification" => "Subsmanからの通知",
    ...
    "ssrf_protection_info" => "Server-Side Request Forgery（SSRF）攻撃を防ぐために、Subsmanはデフォルトでプライベートまたは内部ネットワークアドレスへのWebhook通知をブロックします。",
