...
$i18n = [
    ...
    "api_key_info" => "API Anahtarı, Subsman'un API'sine erişmek için kullanılır. Bu anahtarı kimseyle paylaşmayın.",
    // Settings page
    ...
    "subsman_notification" => "Subsman Bildirimi",
    ...
    "ssrf_protection_info" => "Sunucu tarafı istek sahteciliği (SSRF) saldırılarını önlemek için Subsman, varsayılan olarak webhook bildirimlerini özel veya dahili ağ adreslerine engeller.",
