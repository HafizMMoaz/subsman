...
$i18n = [
    ...
    "api_key_info" => "Το API κλειδί χρησιμοποιείται για την επικοινωνία με το API του Subsman. Μην αποκαλύπτετε το API κλειδί σας σε κανέναν.",
    // Settings page
    ...
    "subsman_notification" => "Ειδοποίηση Subsman",
    ...
    "ssrf_protection_info" => "Για να αποτρέψετε επιθέσεις Server-Side Request Forgery (SSRF), το Subsman αποκλείει από προεπιλογή τις ειδοποιήσεις webhook σε ιδιωτικές ή εσωτερικές διευθύνσεις δικτύου.",
