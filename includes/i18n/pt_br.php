...
$i18n = [
    ...
    "api_key_info" => "A chave da API é usada para acessar a API do Subsman. Não compartilhe sua chave com ninguém.",
    // Settings page
    ...
    "subsman_notification" => "Notificação do Subsman",
    ...
    "ssrf_protection_info" => "Para evitar ataques Server-Side Request Forgery (SSRF), o Subsman bloqueia por padrão notificações webhook para endereços de rede privados ou internos.",
