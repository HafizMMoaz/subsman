...
$i18n = [
    ...
    "subsman_notification" => "Subsman Notification",
    ...
    "ssrf_protection_info" => "To prevent Server-Side Request Forgery (SSRF) attacks, Subsman blocks webhook notifications to private or internal network addresses by default.",
