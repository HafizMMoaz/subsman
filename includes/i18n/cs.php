...
$i18n = [
    ...
    "subsman_notification" => "Oznámení aplikace Subsman",
    ...
    "ssrf_protection_info" => "Aby se předešlo útokům Server-Side Request Forgery (SSRF), Subsman ve výchozím nastavení blokuje webhook notifikace směrem na soukromé nebo interní síťové adresy.",
