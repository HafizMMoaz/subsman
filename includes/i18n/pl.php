...
$i18n = [
    ...
    "subsman_notification" => "Powiadomienie Subsman",
    ...
    "ssrf_protection_info" => "Aby zapobiec atakom Server-Side Request Forgery (SSRF), Subsman domyślnie blokuje powiadomienia webhook wysyłane na prywatne lub wewnętrzne adresy sieciowe.",
