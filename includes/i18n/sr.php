...
$i18n = [
    ...
    "subsman_notification" => "Валос обавештење",
    ...
    "ssrf_protection_info" => "Како би се спречили напади Server-Side Request Forgery (SSRF), Subsman подразумевано блокира webhook обавештења ка приватним или унутрашњим мрежним адресама.",
