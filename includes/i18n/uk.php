...
$i18n = [
    ...
    // Settings page
    "budget_info" => "Якщо ви вкажете бюджет, Subsman буде відображати вашу поточну вартість підписок у порівнянні з вашим бюджетом.",
    "household" => "Сім'я",
    ...
    "smtp_info" => "Пароль SMTP передається і зберігається у вигляді відкритого тексту. З метою безпеки створіть обліковий запис тільки для Subsman.",
    "telegram" => "Telegram",
    ...
    "subsman_notification" => "Сповіщення від Subsman",
    ...
    "ssrf_protection_info" => "Щоб запобігти атакам Server-Side Request Forgery (SSRF), Subsman за замовчуванням блокує вебхуки до приватних або внутрішніх мережевих адрес.",
