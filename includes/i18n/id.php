...
$i18n = [
    ...
    "subsman_notification" => "Notifikasi Subsman",
    ...
    "ssrf_protection_info" => "Untuk mencegah serangan Server-Side Request Forgery (SSRF), Subsman secara default memblokir notifikasi webhook ke alamat jaringan pribadi atau internal.",
