...
$i18n = [
    ...
    "subsman_notification" => "Notification de Subsman",
    ...
    "ssrf_protection_info" => "Pour prévenir les attaques Server-Side Request Forgery (SSRF), Subsman bloque par défaut les notifications webhook vers des adresses réseau privées ou internes.",
