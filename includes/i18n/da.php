...
$i18n = [
    ...
    "subsman_notification" => "Subsman Notifikation",
    ...
    "ssrf_protection_info" => "For at forhindre Server-Side Request Forgery (SSRF) angreb blokerer Subsman som standard webhook-notifikationer til private eller interne netværksadresser.",
