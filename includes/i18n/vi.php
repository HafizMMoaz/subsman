...
$i18n = [
    ...
    "subsman_notification" => "Thông báo Subsman",
    ...
    "ssrf_protection_info" => "Để ngăn chặn các cuộc tấn công Server-Side Request Forgery (SSRF), Subsman mặc định chặn các thông báo webhook đến các địa chỉ mạng riêng hoặc nội bộ.",
