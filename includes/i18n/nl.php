...
$i18n = [
    ...
    "subsman_notification" => "Subsman Notificatie",
    ...
    "ssrf_protection_info" => "Om Server-Side Request Forgery (SSRF) aanvallen te voorkomen, blokkeert Subsman standaard webhookmeldingen naar privé- of interne netwerkadressen.",
