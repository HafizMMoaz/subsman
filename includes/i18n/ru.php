...
$i18n = [
    ...
    // Settings page
    "budget_info" => "Если вы укажете бюджет, Subsman будет отображать вашу текущую стоимость подписок в сравнении с вашим бюджетом.",
    "household" => "Семья",
    ...
    "smtp_info" => "Пароль SMTP передается и сохраняется в виде открытого текста. В целях безопасности создайте учетную запись только для Subsman.",
    "telegram" => "Telegram",
    ...
    "subsman_notification" => "Уведомление от Subsman",
    ...
    "ssrf_protection_info" => "Чтобы предотвратить атаки Server-Side Request Forgery (SSRF), Subsman по умолчанию блокирует уведомления webhook на приватные или внутренние сетевые адреса.",
