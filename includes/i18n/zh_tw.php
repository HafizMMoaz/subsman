...
$i18n = [
    ...
    "api_key" => "API 金鑰",
    "regenerate" => "重新產生",
    "api_key_info" => "API 金鑰用於存取 Subsman API，請妥善保管、勿將此金鑰分享給任何人。",
    // 設定頁面
    "monthly_budget" => "每月預算",
    ...
    "smtp_info" => "SMTP 密碼將以明文傳輸和儲存。為了安全起見，建議為 Subsman 建立專用帳號。",
    "telegram" => "Telegram",
    ...
    "subsman_notification" => "Subsman 通知",
    "test_notification" => "這是一則測試通知。如果您看到此訊息，表示 Subsman 通知功能設定正確。",
    ...
    "ssrf_protection_info" => "為了防止服務端請求偽造（SSRF）攻擊，Subsman 預設會阻止發送到私人或內部網路位址的 webhook 通知。",
