...
$i18n = [
    ...
    "subsman_notification" => "Notificare Subsman",
    ...
    "ssrf_protection_info" => "Pentru a preveni atacurile de tip Server-Side Request Forgery (SSRF), Subsman blochează în mod implicit notificările webhook către adrese de rețea private sau interne.",
